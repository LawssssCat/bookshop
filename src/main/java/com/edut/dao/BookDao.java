...
public interface BookDao {
	 ...
	 * @return
	 */
	public abstract Book getBook(int id)  throws SQLException ;
	 ...
	 * @return
	 */
	public abstract Page<Book> getPage(CriteriaBook cb)  throws SQLException ;
	 ...
	 * @return
	 */
	public abstract long getTotalBookNumber(CriteriaBook cb)  throws SQLException ;
	 ...
	 * @return
	 */
	public abstract List<Book> getPageList(CriteriaBook cb,int pageSize)  throws SQLException ;
	 ...
	 * @return
	 */
	public abstract int getStoreNumber(Integer id)  throws SQLException ;
