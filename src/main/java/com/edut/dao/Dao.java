...
public interface Dao<T> {
	 ...
	 * @return: 插入新记录的 id
	 */
	public abstract Long insert(String sql , Object ... args );
	 ...
	 * @return: 与记录对应的类的一个对象
	 */
	public abstract T query(String sql , Object ... args );
	 ...
	 */
	public abstract <V> V getSingleVal(String sql ,  Object ... args ) ;
